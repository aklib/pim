<?php /** @noinspection PhpUnused */
     ...
     *
     * @ORM\Table(name="attribute_value_number", indexes={@ORM\Index(name="FK_attribute_value_number_attribute_value", columns={"value_id"}), @ORM\Index(name="val", columns={"val"})})
     * @ORM\Entity(repositoryClass="Attribute\Repository\AttributeValueNumberDao")
     */
    class AttributeValueNumber
    {
        /**
         *
         ...
         * @var AttributeValue
         *
         * @ORM\ManyToOne(targetEntity="Attribute\Entity\AttributeValue", inversedBy="valueNumbers")
         * @ORM\JoinColumns({
