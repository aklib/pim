<?php /** @noinspection PhpUnused */
     ...
     * AttributeValueText
     *
     * @ORM\Table(name="attribute_value_text", indexes={})
     * @ORM\Entity(repositoryClass="Attribute\Repository\AttributeValueTextDao")
     */
    class AttributeValueText
    {
        /**
         *
         ...
         * @var AttributeValue
         *
         * @ORM\ManyToOne(targetEntity="Attribute\Entity\AttributeValue", inversedBy="valueTexts", cascade={"persist"})
         * @ORM\JoinColumns({
