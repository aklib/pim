...
var Axis3DAdditions = /** @class */ (function () {
    ...
    Axis3DAdditions.prototype.fix3dPosition = function (pos, isTitle) {
        ...
        var alpha = deg2rad * chart.options.chart.options3d.alpha, beta = deg2rad * chart.options.chart.options3d.beta,
            ...
            skew = pick(isTitle && axis.options.title.skew3d, axis.options.labels.skew3d), frame = chart.chart3d.frame3d, plotLeft = chart.plotLeft,
            plotRight = chart.plotWidth + plotLeft, plotTop = chart.plotTop, plotBottom = chart.plotHeight + plotTop,
...
var Axis3D = /** @class */ (function () {
    ...
    Axis3D.wrapGetPlotLinePath = function (proceed) {
        ...
        var options3d = chart.options.chart.options3d, d = axis.isZAxis ? chart.plotWidth : options3d.depth, frame = chart.chart3d.frame3d, startSegment = path[0],
            endSegment = path[1], pArr, pathSegments = [];
