...
var addEvent = U.addEvent, arrayMax = U.arrayMax, arrayMin = U.arrayMin, clamp = U.clamp, defined = U.defined, extend = U.extend, find = U.find, format = U.format,
    getOptions = U.getOptions, isNumber = U.isNumber, isString = U.isString, merge = U.merge, pick = U.pick, splat = U.splat;
import '../Pointer.js';
...
var Series = H.Series, seriesProto = Series.prototype, seriesInit = seriesProto.init, seriesProcessData = seriesProto.processData,
...
addEvent(Axis, 'afterDrawCrosshair', function (event) {
    ...
    var chart = this.chart, log = this.logarithmic, options = this.options.crosshair.label, // the label's options
        ...
        posx, posy, crossBox, formatOption = options.format, formatFormat = '', limit, align, tickInside = this.options.tickPosition === 'inside',
        snap = this.crosshair.snap !== false, value, offset = 0,
