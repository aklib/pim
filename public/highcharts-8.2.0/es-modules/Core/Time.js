...
var defined = U.defined, error = U.error, extend = U.extend, isObject = U.isObject, merge = U.merge, objectEach = U.objectEach, pad = U.pad, pick = U.pick, splat = U.splat,
...
var Time = /** @class */ (function () {
    ...
    Time.prototype.dateFormat = function (format, timestamp, capitalize) {
        ...
        var time = this, date = new this.Date(timestamp),
            ...
            hours = this.get('Hours', date), day = this.get('Day', date), dayOfMonth = this.get('Date', date), month = this.get('Month', date),
            fullYear = this.get('FullYear', date), lang = H.defaultOptions.lang, langWeekdays = lang === null || lang === void 0 ? void 0 : lang.weekdays,
