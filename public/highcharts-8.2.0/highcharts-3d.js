...
*/
(function (a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/highcharts-3d", ["public/highcharts-8.2.0/highcharts"], function (B) {
        a(B);
        a.Highcharts = B;
        return a
    ...
    B(a, "Extensions/Math3D.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, l) {
        var u = l.pick, d = a.deg2rad, m = a.perspective3D = function (d,
            ...
            var b = a.options.chart.options3d, p = u(r, h ? a.inverted : !1),
                n = {x: a.plotWidth / 2, y: a.plotHeight / 2, z: b.depth / 2, vd: u(b.depth, 1) * u(b.viewDistance, 0)}, q = a.scale3d || 1;
            r = d * b.beta * (p ? -1 : 1);
            b = d * b.alpha * (p ? -1 : 1);
    ...
    B(a, "Core/Renderer/SVG/SVGRenderer3D.js", [a["Core/Color.js"], a["Core/Globals.js"], a["Extensions/Math3D.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Renderer/SVG/SVGRenderer.js"], a["Core/Utilities.js"]], function (a, l, u, d, m, w) {
        ...
        var G = a.parse, p = u.perspective, h = u.shapeArea, r = w.animObject, b = w.defined, L = w.extend, n = w.merge, q = w.objectEach, c = w.pick, A = Math.cos, v = Math.PI,
            e = Math.sin, C = l.charts, M = l.deg2rad;
        var F =
        ...
        m.prototype.cuboidPath = function (c) {
            function e(c) {
                return 0 === D && 1 < c && 6 > c ? {x: a[c].x, y: a[c].y + 10, z: a[c].z} : a[0].x === a[7].x && 4 <= c ? {
                    x: a[c].x + 10,
                    y: a[c].y,
                    z: a[c].z
            ...
            var g = c.x, d = c.y, b = c.z || 0, D = c.height, E = c.width, v = c.depth, t = C[this.chartIndex], y = t.options.chart.options3d.alpha, A = 0, a = [{
                x: g,
                y: d, z: b
            }, {x: g + E, y: d, z: b}, {x: g + E, y: d + D, z: b}, {x: g, y: d + D, z: b}, {x: g, y: d + D, z: b + v}, {x: g + E, y: d + D, z: b + v}, {
                x: g + E,
                y: d,
                z: b + v
            }, {x: g, y: d, z: b + v}], q = [];
                ...
                if (y.duration) {
                    ...
                    if (g) {
                        ...
                        y.step = function (e, f) {
                            ...
                            f.prop === t && f.elem.setPaths(n(v, {x: d("x"), y: d("y"), r: d("r"), innerR: d("innerR"), start: d("start"), end: d("end"), depth: d("depth")}))
                        }
                    }
                    g = y
                }
        ...
        m.prototype.arc3dPath = function (c) {
            ...
            var f = c.x, b = c.y, g = c.start, a = c.end - .00001, h = c.r, q = c.innerR || 0, n = c.depth || 0, t = c.alpha, y = c.beta, J = Math.cos(g), K = Math.sin(g);
            c = Math.cos(a);
            var I = Math.sin(a),
                z = h * Math.cos(y);
            h *= Math.cos(t);
            ...
            a = 1E5 * c;
            b *= 1E5;
            return {top: n, zTop: 1E5 * Math.PI + 1, out: t, zOut: Math.max(g, a, b), inn: y, zInn: Math.max(g, a, b), side1: J, zSide1: .99 * b, side2: f, zSide2: .99 * a}
        }
    });
    ...
    B(a, "Core/Axis/Axis3D.js", [a["Core/Globals.js"], a["Extensions/Math3D.js"], a["Core/Axis/Tick.js"], a["Core/Axis/Tick3D.js"], a["Core/Utilities.js"]], function (a, l, u, d, m) {
        var w = l.perspective, k = l.perspective3D, G = l.shapeArea, p = m.addEvent, h = m.merge, r = m.pick, b = m.wrap, L = a.deg2rad, n = function () {
            ...
            b.prototype.fix3dPosition = function (c, b) {
                ...
                var a = L * e.options.chart.options3d.alpha, h = L * e.options.chart.options3d.beta, q = r(b && d.options.title.position3d, d.options.labels.position3d);
                ...
                "chart" !== q && ("flap" === q ? d.horiz ? (h = Math.sin(a), a = Math.cos(a), d.opposite && (h = -h), e && (h = -h), l = {
                    ...
                    l.x + l.y * l.y + l.z * l.z), e && (a = -a), l = {x: a * l.x, y: a * l.y, z: a * l.z}) : g = {
                    x: Math.cos(h),
                    y: 0,
                    z: Math.sin(h)
                } : d.horiz ? l = {x: Math.sin(h) * Math.sin(a), y: Math.cos(a), z: -Math.cos(h) * Math.sin(a)} : g = {x: Math.cos(h), y: 0, z: Math.sin(h)});
                c.x += p * g.x + m * l.x;
                c.y += p * g.y + m * l.y;
                c.z += p * g.z + m * l.z;
                e = w([c], d.chart)[0];
                b && (0 > G(w([c, {x: c.x + g.x, y: c.y + g.y, z: c.z + g.z}, {x: c.x + l.x, y: c.y + l.y, z: c.z + l.z}], d.chart)) && (g = {
                    x: -g.x,
                    y: -g.y,
                    z: -g.z
                }), c = w([{x: c.x, y: c.y, z: c.z}, {x: c.x + g.x, y: c.y + g.y, z: c.z + g.z}, {x: c.x + l.x, y: c.y + l.y, z: c.z + l.z}], d.chart), e.matrix =
        ...
        return function () {
            ...
            a.wrapGetPlotLinePath = function (c) {
                ...
                var k = e[0], n = e[1];
                e = [];
                "M" === k[0] && "L" === n[0] && (d = [d.swapZ({x: k[1], y: k[2], z: 0}), d.swapZ({x: k[1], y: k[2], z: h}), d.swapZ({x: n[1], y: n[2], z: 0}), d.swapZ({
                    x: n[1],
                    y: n[2],
                    z: h
            ...
            a.wrapGetSlotWidth = function (c, d) {
                ...
                if (this.categories && b.frameShapes && b.is3d() && h && d && d.label) {
                    ...
                    b = {x: b.plotWidth / 2, y: b.plotHeight / 2, z: q.depth / 2, vd: r(q.depth, 1) * r(q.viewDistance, 0)};
                    var p, g;
                    q = d.pos;
                    var m = a[q - 1];
                    a =
        ...
        (function (a) {
            ...
            function k() {
                if (this.chart3d && this.is3d()) {
                    var c = this.renderer, a = this.options.chart.options3d, b = this.chart3d.get3dFrame(), e = this.plotLeft, f = this.plotLeft + this.plotWidth, g = this.plotTop,
                        h = this.plotTop +
                            this.plotHeight;
                    a = a.depth;
                    var k = e - (b.left.visible ? b.left.size : 0), q = f + (b.right.visible ? b.right.size : 0), n = g - (b.top.visible ? b.top.size : 0),
                        m = h + (b.bottom.visible ? b.bottom.size : 0), p = 0 - (b.front.visible ? b.front.size : 0), l = a + (b.back.visible ? b.back.size : 0),
                    ...
                    this.frameShapes.back[v]({
                        ...
                        }, {fill: d.color(b.back.color).get(), vertexes: [{x: k, y: m, z: l}, {x: q, y: m, z: l}, {x: q, y: n, z: l}, {x: k, y: n, z: l}], enabled: b.back.visible}]
                    });
                    ...
                    [{name: "darker", slope: .6}, {name: "brighter", slope: 1.4}].forEach(function (c) {
                        this.renderer.definition({
                            ...
                            children: [{
                                ...
                                children: [{tagName: "feFuncR", type: "linear", slope: c.slope}, {tagName: "feFuncG", type: "linear", slope: c.slope}, {
                                    tagName: "feFuncB",
                                    type: "linear",
                                    slope: c.slope
                                }]
            ...
            var D = function () {
                ...
                c.prototype.get3dFrame = function () {
                    var c = this.chart, b = c.options.chart.options3d, a = b.frame, d = c.plotLeft, e = c.plotLeft + c.plotWidth, f = c.plotTop, g = c.plotTop + c.plotHeight,
                        k = b.depth, n = function (a) {
                            a = h(a, c);
                        ...
                        v = n([{x: d, y: f, z: 0}, {x: d, y: f, z: k}, {x: d, y: g, z: k}, {x: d, y: g, z: 0}]), r = n([{x: e, y: f, z: k}, {
                            x: e, y: f,
                            z: 0
                        }, {x: e, y: g, z: 0}, {x: e, y: g, z: k}]), A = n([{x: d, y: g, z: 0}, {x: e, y: g, z: 0}, {x: e, y: f, z: 0}, {x: d, y: f, z: 0}]);
                    ...
                    "auto" === b.axisLabelPosition ? (r = function (c, a) {
                        ...
                        a.front) && b.push({y: (f + g) / 2, x: d, z: 0, xDir: {x: 1, y: 0, z: 0}}), r(a.left, a.back) && b.push({
                        y: (f + g) / 2,
                        x: d,
                        z: k,
                        xDir: {x: 0, y: 0, z: -1}
                    }), r(a.right, a.front) && b.push({y: (f + g) / 2, x: e, z: 0, xDir: {x: 0, y: 0, z: 1}}), r(a.right, a.back) && b.push({
                        y: (f + g) / 2,
                        x: e,
                        z: k,
                        xDir: {x: -1, y: 0, z: 0}
                    }), m = [], r(a.bottom, a.front) && m.push({x: (d + e) / 2, y: g, z: 0, xDir: {x: 1, y: 0, z: 0}}), r(a.bottom, a.back) && m.push({
                        x: (d + e) / 2,
                        y: g,
                        z: k,
                        xDir: {x: -1, y: 0, z: 0}
                    }), l = [], r(a.top, a.front) && l.push({x: (d + e) / 2, y: f, z: 0, xDir: {x: 1, y: 0, z: 0}}), r(a.top, a.back) && l.push({
                        x: (d + e) /
                            2, y: f, z: k, xDir: {x: -1, y: 0, z: 0}
                    }), v = [], r(a.bottom, a.left) && v.push({z: (0 + k) / 2, y: g, x: d, xDir: {x: 0, y: 0, z: -1}}), r(a.bottom, a.right) && v.push({
                        z: (0 + k) / 2,
                        y: g,
                        x: e,
                        xDir: {x: 0, y: 0, z: 1}
                    }), g = [], r(a.top, a.left) && g.push({z: (0 + k) / 2, y: f, x: d, xDir: {x: 0, y: 0, z: -1}}), r(a.top, a.right) && g.push({
                        z: (0 + k) / 2,
                        y: f,
                        x: e,
                        xDir: {x: 0, y: 0, z: 1}
                        ...
                        y: {left: {x: d, z: 0, xDir: {x: 1, y: 0, z: 0}}, right: {x: e, z: 0, xDir: {x: 0, y: 0, z: 1}}},
                        x: {top: {y: f, z: 0, xDir: {x: 1, y: 0, z: 0}}, bottom: {y: g, z: 0, xDir: {x: 1, y: 0, z: 0}}},
                        z: {
                ...
                c.prototype.getScale = function (c) {
                    var a = this.chart, b = a.plotLeft, d = a.plotWidth + b, e = a.plotTop, f = a.plotHeight +
                        e, g = b + a.plotWidth / 2, h = e + a.plotHeight / 2, k = Number.MAX_VALUE, n = -Number.MAX_VALUE, q = Number.MAX_VALUE, m = -Number.MAX_VALUE, l = 1;
    ...
    B(a, "Series/Column3DSeries.js", [a["Core/Globals.js"], a["Extensions/Math3D.js"],
        ...
        b.column.prototype.translate3dShapes = function () {
            var a = this, b = a.chart, c = a.options, d = c.depth, h = (c.stacking ? c.stack || 0 : a.index) * (d + (c.groupZPadding || 1)), e = a.borderWidth % 2 ? .5 : 0, k;
        ...
        l(r, "afterInit", function () {
            if (this.chart.is3d() &&
                ...
                var a = this.options, b = a.grouping, c = a.stacking, d = h(this.yAxis.options.reversedStacks, !0), k = 0;
        ...
        l(m.pie.prototype, "drawDataLabels", function (a) {
            if (this.chart.is3d()) {
                ...
                this.data.forEach(function (a) {
                    ...
                    a = a.labelPosition;
                    var m = a.connectorPosition, n = -l * (1 - Math.cos((h.alpha || k.alpha) * d)) * Math.sin(b), p = l * (Math.cos((h.beta || k.beta) * d) - 1) * Math.cos(b);
