...
(function (factory) {
    if (typeof module === 'object' && module.exports) {
        ...
        define('highcharts/highcharts-3d', ['public/highcharts-8.2.0/highcharts'], function (Highcharts) {
            factory(Highcharts);
        ...
        (function (Chart3D) {
            ...
            function onAfterSetChartSize() {
                ...
                if (chart.chart3d &&
                    ...
                    var inverted = chart.inverted, clipBox = chart.clipBox, margin = chart.margin, x = inverted ? 'y' : 'x', y = inverted ? 'x' : 'y',
                        w = inverted ? 'height' : 'width', h = inverted ? 'width' : 'height';
