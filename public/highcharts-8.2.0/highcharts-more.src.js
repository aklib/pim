...
(function (factory) {
    if (typeof module === 'object' && module.exports) {
        ...
        define('highcharts/highcharts-more', ['public/highcharts-8.2.0/highcharts'], function (Highcharts) {
            factory(Highcharts);
            ...
            RadialAxis.init = function (axis) {
                ...
                axis.getPlotLinePath = function (options) {
                    var axis = this, center = axis.pane.center, chart = axis.chart, inverted = chart.inverted, value = options.value, reverse = options.reverse,
                        ...
                        {}, innerRadius = background.innerRadius || '0%', outerRadius = background.outerRadius || '100%', x1 = center[0] + chart.plotLeft,
                        y1 = center[1] + chart.plotTop, x2 = end.x, y2 = end.y, height = axis.height, isCrosshair = options.isCrosshair, paneInnerR = center[3] / 2, innerRatio,
