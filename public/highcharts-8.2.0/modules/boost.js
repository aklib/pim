...
(function (b) {
    ...
    n(b, "Extensions/Boost/WGLRenderer.js", [b["Core/Globals.js"], b["Extensions/Boost/WGLShader.js"], b["Extensions/Boost/WGLVBuffer.js"], b["Core/Color.js"], b["Core/Utilities.js"]], function (b, l, E, m, d) {
        ...
        return function (d) {
            ...
            function O(c, a) {
                ...
                var Z = c.pointArrayMap && "low,high" === c.pointArrayMap.join(","), P = c.chart, f = c.options, G = !!f.stacking, I = f.data, g = c.xAxis.getExtremes(), h = g.min;
                g = g.max;
                var B = c.yAxis.getExtremes(),
                    q = B.min;
                B = B.max;
                var l = c.xData || f.xData || c.processedXData, O = c.yData || f.yData || c.processedYData, r = c.zData || f.zData || c.processedZData, n = c.yAxis, w = c.xAxis,
                    E = c.chart.plotWidth, J = !l || 0 === l.length, L = f.connectNulls, u = c.points || !1, F = !1, K = !1, Q;
                l = G ? c.data : l || I;
                var X = {x: Number.MAX_VALUE, y: 0}, M = {x: -Number.MAX_VALUE, y: 0}, T = 0, W = !1, D = -1, S = !1, U = !1, ka = "undefined" === typeof P.index, fa = !1, ha = !1;
                var x = !1;
            ...
            var c = !1, H = !1, e = !1, n = 0, K = 0, N = !1, L = !1, W = {}, T = !1, F = [], M = {}, ma = {column: !0, columnrange: !0, bar: !0, area: !0, arearange: !0},
                ka = {scatter: !0, bubble: !0}, y = {
                    pointSize: 1,
                    lineWidth: 1,
                    fillColor: "#AA00AA",
                    useAlpha: !0,
                    ...
                    debug: {timeRendering: !1, timeSeriesProcessing: !1, timeSetup: !1, timeBufferCopy: !1, timeKDTree: !1, showSkipSummary: !1}
                };
            return W = {
                ...
                pushSeries: function (a) {
                    ...
                    function k(a, c) {
                        var b = {isReady: !1, texture: w.createElement("canvas"), handle: e.createTexture()}, k = b.texture.getContext("2d");
                        M[a] = b;
                        b.texture.width = 512;
                        b.texture.height =
                            512;
    ...
    n(b, "Extensions/Boost/BoostAttach.js", [b["Extensions/Boost/WGLRenderer.js"],
        ...
        return function (g, n) {
            ...
            a.renderTarget || (a.canvas = v, g.renderer.forExport || !p ? (a.renderTarget = g.renderer.image("", 0, 0, q, r).addClass("highcharts-boost-canvas").add(w), a.boostClear = function () {
                ...
                q = g.chartWidth;
                r = g.chartHeight;
                (a.renderTargetFo || a.renderTarget).attr({x: 0, y: 0, width: q, height: r}).css({pointerEvents: "none", mixedBlendMode: "normal", opacity: 1});
    ...
    n(b, "Extensions/Boost/BoostUtils.js",
        [b["Core/Globals.js"], b["Extensions/Boost/BoostableMap.js"], b["Extensions/Boost/BoostAttach.js"], b["Core/Utilities.js"]], function (b, l, n, m) {
            ...
            m = {
                patientMax: d, boostEnabled: function (a) {
    ...
    n(b, "Extensions/Boost/BoostInit.js", [b["Core/Chart/Chart.js"], b["Core/Globals.js"], b["Core/Utilities.js"], b["Extensions/Boost/BoostUtils.js"], b["Extensions/Boost/BoostAttach.js"]], function (b, l, n, m, d) {
        var v = n.addEvent, g = n.extend, z = n.fireEvent, q = n.wrap, r = l.Series, a = l.seriesTypes, w = function () {
        ...
        return function () {
            g(r.prototype, {
                renderCanvas: function () {
                    ...
                    var k = this, f = k.options || {}, c = !1, g = k.chart, e = this.xAxis, h = this.yAxis, l = f.xData || k.processedXData, m = f.yData || k.processedYData,
                        n = f.data;
                    c = e.getExtremes();
                    var q = c.min, r = c.max;
                    c = h.getExtremes();
                    var v = c.min, M = c.max, L = {}, O, y = !!k.sampling, Z = !1 !== f.enableMouseTracking, P = h.getThreshold(f.threshold),
                        la = k.pointArrayMap && "low,high" === k.pointArrayMap.join(","), na = !!f.stacking, oa = k.cropStart || 0, wa = k.requireSorting, pa = !l, ca, da, R, aa,
                        xa = "x" === f.findNearestPointBy, qa = this.xData || this.options.xData || this.processedXData || !1, ea = function (a, c, b) {
                            a = Math.ceil(a);
                            J = xa ? a : a + "," + c;
                            Z && !L[J] && (L[J] = !0, g.inverted && (a = e.len - a, c = h.len - c), ya.push({x: qa ? qa[oa + b] : !1, clientX: a, plotX: a, plotY: c, i: oa + b}))
                        };
                    c = d(g, k);
                    g.isBoosting =
                        !0;
    ...
    n(b, "Extensions/Boost/BoostOverrides.js",
        [b["Core/Chart/Chart.js"], b["Core/Globals.js"], b["Core/Series/Point.js"], b["Core/Utilities.js"], b["Extensions/Boost/BoostUtils.js"], b["Extensions/Boost/Boostables.js"], b["Extensions/Boost/BoostableMap.js"]], function (b, l, n, m, d, L, g) {
            var v = m.addEvent, q = m.error, r = m.getOptions, a = m.isArray, w = m.isNumber, p = m.pick, f = m.wrap, B = d.boostEnabled, E = d.shouldForceChartSeriesBoosting,
                h = l.Series, J = l.seriesTypes, G = r().plotOptions;
            ...
            h.prototype.hasExtremes = function (a) {
                var b =
                    this.options, d = this.xAxis && this.xAxis.options, c = this.yAxis && this.yAxis.options, f = this.colorAxis && this.colorAxis.options;
